...
for filename, content in docs.items():
    with open(os.path.join("support_assistant/docs", filename), "w", encoding="utf-8") as f:
        f.write(content)
...
with open("support_assistant/main.py", "w", encoding="utf-8") as f:
    f.write(main_code)
...
with open("support_assistant/Dockerfile", "w", encoding="utf-8") as f:
    f.write(dockerfile_code)

print("Module 3 files successfully generated inside /support_assistant!")
'''
